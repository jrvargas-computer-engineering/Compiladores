...
static const char *const yytname[] =
{
  ...
  "TIMES", "LEFT", "RIGHT", "END", "END_OF_FILE", "$accept", "Input",
  "Line", "E", "T", "F", YY_NULLPTR
};
...
#line 37 "calc.y"
    ...
    (yyval.arvore)->value = (yyvsp[-2].arvore)->value + (yyvsp[0].arvore)->value;     
}
...
#line 55 "calc.y"
           {      
    char buf[32];
    sprintf(buf, "%.2f", (yyvsp[0].valor));
    (yyval.arvore) = asd_new(buf);
    (yyval.arvore)->value = (yyvsp[0].valor);
}
